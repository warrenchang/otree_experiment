...
SESSION_CONFIGS = [
    {
        'name': 'AsymPD_ASYM_with_belief',
        'display_name': "Repeated asymmetric PD, asymmetric treatment with belief elicitation",
    ...
    {
        'name': 'AsymPD_SYM_with_belief',
        'display_name': "Repeated asymmetric PD, symmetric treatment with belief elicitation",
        'num_demo_participants': 4,
        'treatment': 'SYM',
        'belief_elicitation' : True,
        # 'debug': False,
    ...
    {
        'name': 'AsymPD_ASYM',
        'display_name': "Repeated asymmetric PD, asymmetric treatment, NO belief elicitation",
        'num_demo_participants': 4,
        'treatment': 'ASYM',
        # 'debug': False,
        'real_world_currency_per_point': 1 / 40,
    ...
    {
        'name': 'AsymPD_SYM',
        'display_name': "Repeated asymmetric PD, symmetric treatment, NO belief elicitation",
        'num_demo_participants': 4,
        'treatment': 'SYM',
        # 'debug': False,
        'real_world_currency_per_point': 1 / 40,
